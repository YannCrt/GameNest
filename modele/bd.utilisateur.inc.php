...
function deleteAccount($mailU) {
    try {
        // Supprimez l'utilisateur de la base de données en fonction de son adresse e-mail
        $cnx = connexionPDO();
        ...
        if (isLoggedOn()) {
            // Vérifiez si l'utilisateur connecté est celui dont le compte est supprimé
            if ($_SESSION["mailU"] == $mailU) {
